    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  {
        ...
        public MyViewHolder(View view)  {
           ...
           /* view.setOnClickListener(this);*/
            passbook_date= (TextView) view.findViewById(R.id.report_Acc_no);
            passbook_name = (TextView) view.findViewById(R.id.report_Lent);
            passbook_taken_money = (TextView) view.findViewById(R.id.report_Interest);
            passbook_received_money = (TextView) view.findViewById(R.id.report_Earned);
            report_report_Balance = (TextView) view.findViewById(R.id.report_Balance);
