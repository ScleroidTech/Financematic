 ...
 * @since 4/5/18
 */
public class LocalCustomerData implements DataSource<Customer> {
    private final AppDatabase appDatabase;
    private final AppExecutors appExecutors;

    @Inject
    private LocalCustomerData(final AppDatabase appDatabase, final AppExecutors appExecutors) {
     ...
     */
    @Override
    public void getItem(@NonNull final int ItemId, @NonNull final GetCallback callback) {
     ...
     */
    @Override
    public void saveItem(@NonNull final Customer item) {
     ...
     */
    @Override
    public void addItem(@NonNull final Customer item) {
     ...
     */
    @Override
    public void addItems(@NonNull final List<Customer> items) {
     ...
     */
    @Override
    public void deleteItem(@NonNull final Customer item) {
