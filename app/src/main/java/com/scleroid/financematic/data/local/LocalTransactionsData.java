 ...
 * @since 4/5/18
 */
public class LocalTransactionsData implements DataSource<TransactionModel> {
    private final AppDatabase appDatabase;
    private final AppExecutors appExecutors;

    @Inject
    private LocalTransactionsData(final AppDatabase appDatabase, final AppExecutors appExecutors) {
     ...
     */
    @Override
    public void saveItem(@NonNull final TransactionModel item) {
     ...
     */
    @Override
    public void addItem(@NonNull final TransactionModel item) {
     ...
     */
    @Override
    public void addItems(@NonNull final List<TransactionModel> items) {
     ...
     */
    @Override
    public void deleteItem(@NonNull final TransactionModel item) {
