 ...
 * @since 4/5/18
 */
public class LocalExpenseData implements DataSource<Expense> {
    private final AppDatabase appDatabase;
    private final AppExecutors appExecutors;

    @Inject
    private LocalExpenseData(final AppDatabase appDatabase, final AppExecutors appExecutors) {
     ...
     */
    @Override
    public void saveItem(@NonNull final Expense item) {
     ...
     */
    @Override
    public void addItem(@NonNull final Expense item) {
     ...
     */
    @Override
    public void addItems(@NonNull final List<Expense> items) {
     ...
     */
    @Override
    public void deleteItem(@NonNull final Expense item) {
