...
/**
 * This is a Dagger component. Refer to {@link App} for the list of Dagger components used in this
 * application.
 * <p>
 * Even though Dagger allows annotating a {@link Component} as a singleton, the code itself must
 * ensure only one instance of the class is created. This is done in {@link App}. //{@link
