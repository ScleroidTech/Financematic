...
/**
 * Demonstrate Firebase Authentication without a password, using a link sent to an email address.
 */
public class PasswordlessActivity extends BaseActivity implements View.OnClickListener {
	...
	/**
	 * Check to see if the Intent has an email link, and if so set up the UI accordingly. This can
	 * be called from either onCreate or onNewIntent, depending on how the Activity was launched.
	 */
	...
	/**
	 * Sign in using an email address and a link, the link is passed to the Activity from the
	 * dynamic link contained in the email.
	 */
